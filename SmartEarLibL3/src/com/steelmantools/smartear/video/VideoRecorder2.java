...
public class VideoRecorder2 {
	...
	private static final String LOG_TAG = VideoRecorder2.class.getSimpleName();
	 ...
	 */
	public VideoRecorder2(MainActivity activity, List<File> rawFiles, Map<Long, Integer> channelStates) {
