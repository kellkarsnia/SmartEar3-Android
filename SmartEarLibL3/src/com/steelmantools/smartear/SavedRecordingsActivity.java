...
public class SavedRecordingsActivity extends FragmentActivity {
	...
	public static final String LOG_TAG = SavedRecordingsActivity.class.getSimpleName();
			...
			public void onClick(View v) {
				if (selectedRecording != null) {
					...
					if (selectedRecording.isVideo()) {
						...
						emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "SmartEAR 3 MP4 File");
					} else {
						emailIntent.setType("audio/wav");
						emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "SmartEAR 3 Wave File");
					}
					emailIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Created using the SmartEAR 3 App");
	...
	public void refreshAdapter() {
		recordings = SavedRecording.getAllRecordings();
		recordingsListView.setAdapter(new SavedRecordingsAdapter(this, recordings));
	}
	...
	public void itemClicked(View background, int position) {
		...
		((SavedRecordingsAdapter) recordingsListView.getAdapter()).notifyDataSetChanged();
	}
	...
	public void onBackPressed() {
	      Intent connectedIntent = new Intent(SavedRecordingsActivity.this, MainActivity.class);
