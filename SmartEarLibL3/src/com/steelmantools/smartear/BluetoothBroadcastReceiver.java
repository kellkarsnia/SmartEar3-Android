...
//    public static void unRegister (Callback callback, Context c) {
//        c.unregisterReceiver(new BluetoothBroadcastReceiver(callback), getFilter());
//    }
    ...
    public void onReceive (Context context, Intent intent) {
        ...
        switch (state) {
            case BluetoothAdapter.STATE_CONNECTED:
                ...
                Log.v(TAG, "safeUnregisterReceiver FIRED STATE_CONNECTED");
                break;
            case BluetoothAdapter.ERROR:
                safeUnregisterReceiver(context, this);
                fireOnBluetoothError();
                Log.v(TAG, "safeUnregisterReceiver FIRED ERROR");
                break;
        }
    }
    
    private static void safestUnregisterReceiver () {
    	//safeUnregisterReceiver(context, this);
    }
