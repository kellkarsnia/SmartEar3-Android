...
public class DeviceNotFoundDialogActivity extends Activity {
	...
	public final static String LOG_TAG = DeviceNotFoundDialogActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
			...
			// set title
			alertDialogBuilder.setTitle("Device Not Available");
 
			// set dialog message
			alertDialogBuilder
				.setMessage("Please check that the device is turned on and in range, then try again.")
				.setCancelable(false)
...
//					        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		     	          	Intent intentSelect = new Intent(DeviceNotFoundDialogActivity.this, BluetoothSelectActivity.class);
				...
				.setNegativeButton("1) Set Devices",new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog,int id) {
						setAddressesOnStart();
	     	          	Intent intent = new Intent(DeviceNotFoundDialogActivity.this, BluetoothSetDevicesActivity.class);
	        ...
	        if(names !=null && names.length>0){
		        ...
		        if(GlobalSettings.getDeviceCheck().equals("YES")){
		        	//Toast.makeText(this, "rnOrJS equals YES", Toast.LENGTH_LONG).show();
     	          	...
     	          	Intent intent = new Intent(DeviceNotFoundDialogActivity.this, HardwareDialogActivity.class);
     	          	startActivity(intent);
		        }
	        } else{
